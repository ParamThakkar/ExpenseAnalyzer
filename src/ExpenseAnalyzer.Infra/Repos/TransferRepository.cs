...
/// <summary>
/// Repository implementation for Transfer entity operations.
/// </summary>
public class TransferRepository : Repository<Transfer>, ITransferRepository
{
    ...
    public async Task<IEnumerable<Transfer>> GetAllOrderedByDateAsync(CancellationToken cancellationToken = default)
    {
        return await _context.Transfer
            .OrderByDescending(t => t.Timestamp)
            .ToListAsync(cancellationToken);
