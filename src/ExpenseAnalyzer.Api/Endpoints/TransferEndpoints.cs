...
public static class TransferEndpoints
{
    public static void MapTransferEndpoints(this WebApplication app, ApiVersionSet versionSet)
    {
        ...
        group.MapGet("/outgoing/{accountId:guid}/total", GetTotalTransferredByAccountAsync)
            .WithName("GetTotalTransferredByAccount")
    ...
    {
        var transfers = await repo.GetAllOrderedByTimestampAsync(ct);
    ...
    public static async Task<IResult> GetTotalTransferredByAccountAsync(Guid accountId, ITransferRepository repo, CancellationToken ct)
    {
        var total = await repo.GetTotalTransferredByAccountAsync(accountId, ct);
